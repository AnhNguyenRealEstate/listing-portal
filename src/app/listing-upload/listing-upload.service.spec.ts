...
import { connectStorageEmulator, FirebaseStorage, getStorage, provideStorage, Storage } from "@angular/fire/storage";
...
describe('Listing Upload Service', () => {
    ...
    it('should be able to upload a new listing and then delete it', async () => {
        ...
        listingFromServer.id = id ;
        await listingCard.deleteListing(listingFromServer);
